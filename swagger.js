...
const swaggerDefinition = {
  openapi: '3.0.0',
  info: {
    title: 'Delta-AI API Documentation',
    version: '1.0.0',
    description: 'API documentation for the Delta-AI application',
    license: {
      name: 'MIT',
      url: 'https://opensource.org/licenses/MIT',
    },
    contact: {
      name: 'Delta Analytical Corp',
      url: 'https://github.com/Delta-Analytical-Corp',
    },
  },
  servers: [
    {
